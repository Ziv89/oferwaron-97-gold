...
import { PineProcessor } from '../PineTS.class.ts';
...
export class PineRequest {
    ...
    async security(
        ...
        const pineTS = new PineProcessor(this.context.source, _symbol, _timeframe, this.context.limit || 1000, this.context.sDate, this.context.eDate);
